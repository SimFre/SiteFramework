...
require_once ROOT. "libs" . DIRECTORY_SEPARATOR . "MySQLControl.class.php";
$db = new MySQLControl();
$db->hostname = "";
$db->username = "";
$db->password = "";
...
require_once ROOT. "libs" . DIRECTORY_SEPARATOR . "Site.class.php";
$site = new Site();
...
require_once ROOT. "libs" . DIRECTORY_SEPARATOR . "Admin.class.php";
require_once ROOT. "libs" . DIRECTORY_SEPARATOR . "Admin_User.class.php";
require_once ROOT. "libs" . DIRECTORY_SEPARATOR . "Admin_Auth.class.php";
require_once ROOT. "libs" . DIRECTORY_SEPARATOR . "Admin_Auth_adLDAP.class.php";
$admin = new Admin();
$site->admin    = &$admin;
...
require_once ROOT. "libs" . DIRECTORY_SEPARATOR . "FileManager.class.php";
require_once ROOT. "libs" . DIRECTORY_SEPARATOR . "UploadedFile.class.php";
